...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg1.hasClass("inview")) {
            bg1.css({'backgroundPosition': newPos(50, windowHeight, pos, -1000, 0.2)});
        }
        if ($bg2.hasClass("inview")) {
            bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, 2000, -0.25)});
        }
        if ($bg3.hasClass("inview")) {
            bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 500, 0.4)});
        }
